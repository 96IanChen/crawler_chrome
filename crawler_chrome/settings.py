"""
Django settings for crawler_chrome project.
...
SECRET_KEY = 'django-insecure--*m(g$qi^@1limm6p&@zoy%x%tjl_$_r04*w35jjx5+v7@6ve1'
...
ROOT_URLCONF = 'crawler_chrome.urls'
...
WSGI_APPLICATION = 'crawler_chrome.wsgi.application'
